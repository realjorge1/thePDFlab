...
// Formatting toolbar — Bold, Italic, Align, Color, etc.
// ============================================================
...
const Toolbar: React.FC<ToolbarProps> = ({ onImport, onExport, onUndo, onRedo }) => {
  ...
  const applyStyle = useCallback(
    (updates: Partial<CellStyle>) => {
      if (!selection) return;
      if (selection.range) {
        setRangeStyle(selection.range, updates);
      } else {
        setCellStyle(selection.cell, updates);
      }
    },
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <ToolBtn
          ...
          active={style.bold}
          onPress={toggleBold}
          textStyle={styles.boldLabel}
        />
        <ToolBtn
          label="I"
          active={style.italic}
          onPress={toggleItalic}
          textStyle={styles.italicLabel}
        />
        <ToolBtn
          label="U"
          active={style.underline}
          onPress={toggleUnderline}
          textStyle={styles.underlineLabel}
        />
        ...
        <ToolBtn
          label="⬅"
          active={style.align === 'left' || !style.align}
