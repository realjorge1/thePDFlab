...
function createDefaultPresentation(title = 'New Presentation'): PPTPresentation {
  return {
    id: uuid(),
    title,
...
function initialState(initial?: PPTPresentation): EditorReducerState {
  const presentation = initial ?? createDefaultPresentation();
  return {
    presentation,
...
// ─── Hook ────────────────────────────────────
export function usePPTEditor(initial?: PPTPresentation) {
