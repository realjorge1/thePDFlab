// ============================================================
// store/spreadsheetStore.ts  [UPDATED — OFFLINE PERSISTENCE]
//
// Changes from v1:
//  • Every mutating action calls scheduleAutoSave() automatically
//  • loadSavedState() action restores from device on app launch
...
import { addressToA1, a1ToAddress, getCellsInRange } from '../utils/addressUtils';
import { evaluateFormula, recalculateSheet } from '../utils/formulaEngine';
import { scheduleAutoSave, loadFromDevice, clearSavedData } from '../utils/persistence';
...
// Helper: trigger auto-save after any mutation
