...
export const AI_SUGGESTIONS: Partial<Record<AIAction, string[]>> = {
  ...
  "devils-advocate": [
    "What's the weakest claim in this document?",
    "Who will push back hardest on this — and why?",
    "What objection could sink this in the room?",
    "Where am I assuming something I haven't proven?",
    "What would a skeptical investor attack first?",
    "What's the blind spot a CFO will spot instantly?",
    "Which numbers will get challenged?",
    "What competitor angle did I fail to address?",
  ],
  "narrative-arc": [
    "Does my story actually flow?",
    "Is my proof before my problem?",
    "What's the right order for these sections?",
    "Does this read like a real proposal or a pile of topics?",
    "Where does the structure break down?",
    "Is my conclusion set up properly?",
    "Should I move my pricing later?",
    "What's the ideal arc for this kind of document?",
  ],
  "generate-document": [
